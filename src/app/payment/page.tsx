...
export default function PaymentPage() {
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      if (success) {
        // Create booking & decrement seat ONLY after payment confirmation
  ...
  return (
    <div className="bg-white pb-[140px] min-h-full">
      <div className="pt-[60px] px-5 pb-3">
        ...
        <p className="text-[13px] text-text-muted ml-8">
          {t("almostThere", language)}
        </p>
      </div>
      ...
      <AnimatePresence>
        {error && (
          ...
          >
            <AlertCircle
              size={16}
              className="text-badge-red-text flex-shrink-0 mt-0.5"
            />
