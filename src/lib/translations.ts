...
const translations: Record<TranslationKey, Record<Language, string>> = {
  ...
  goBackHome: {
    EN: "Go back to Home and select your departure and destination cities",
    RW: "Subira ahande uhitemo umudugu wo kuvayo no kujyayo",
  },
  ...
  security: {
    EN: "256-bit encrypted · Safe & secure",
    RW: "Birinzwe 256-bit · Birinzwe neza",
  },

  // Ticket
  bookingConfirmed: { EN: "Booking Confirmed!", RW: "Gutumiza Byemejwe!" },
  eTicketReady: {
    EN: "Your e-ticket is ready",
    RW: "Ikarita yawe yelekironike iri gutegure",
  },
  ...
  noUpcoming: {
    ...
    RW: "Nta rugendo ruraza. Tumiza rugendo rwawe rukurikira!",
  },
  ...
  askRugendo: {
    EN: "Ask Rugendo anything...",
    RW: "Baza Rugendo ikintu cyose...",
  },
  rugendoWelcome1: {
    EN: "Muraho! Nitwa Rugendo 🚌",
    RW: "Muraho! Nitwa Rugendo 🚌",
  },
  rugendoWelcome2: {
